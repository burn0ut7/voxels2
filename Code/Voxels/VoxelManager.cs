public sealed class VoxelManager : Component, Component.ExecuteInEditor
{
	...
	public void RunGpuClipboxSeamProof()
	{
		...
		Log.Info( $"Voxel GPU production clipbox seam proof: result={(_lastGpuClipboxSeamProofResult.Passed ? "PASS" : "FAIL")}, transitions={_lastGpuClipboxSeamProofResult.PublishedTransitions:N0}/{_lastGpuClipboxSeamProofResult.ActiveTransitions:N0}, missing={_lastGpuClipboxSeamProofResult.MissingTransitions:N0}, dependencies={_lastGpuClipboxSeamProofResult.DependencyMismatches:N0}, faceMasks={_lastGpuClipboxSeamProofResult.FaceMaskMismatches:N0}, duplicates={_lastGpuClipboxSeamProofResult.DuplicateRegularTriangles + _lastGpuClipboxSeamProofResult.DuplicateTransitionTriangles + _lastGpuClipboxSeamProofResult.CrossOwnerDuplicateTriangles:N0} (regular={_lastGpuClipboxSeamProofResult.DuplicateRegularTriangles:N0}, transition={_lastGpuClipboxSeamProofResult.DuplicateTransitionTriangles:N0}, crossOwner={_lastGpuClipboxSeamProofResult.CrossOwnerDuplicateTriangles:N0}, lod5={_lastGpuClipboxSeamProofResult.Lod5DuplicateTriangles:N0}), collapsedTransitions={_lastGpuClipboxSeamProofResult.CollapsedTransitionMeshes:N0}, undeformedCoarseBoundaryVertices={_lastGpuClipboxSeamProofResult.UndeformedCoarseBoundaryVertices:N0}, backfacingTransitionTriangles={_lastGpuClipboxSeamProofResult.BackfacingTransitionTriangles:N0}, boundary={_lastGpuClipboxSeamProofResult.BoundaryVertices:N0}/{_lastGpuClipboxSeamProofResult.UnmatchedBoundaryVertices:N0}, maxSeamError={_lastGpuClipboxSeamProofResult.MaximumSeamPositionError:F6}, readback={FormatBytes( _lastGpuClipboxSeamProofResult.GeometryReadbackBytes )} in {_lastGpuClipboxSeamProofResult.GeometryReadbackMilliseconds:F3}ms, validation={_lastGpuClipboxSeamProofResult.Failure}." );
	}
	...
	internal VoxelGpuClipboxSeamProofReport? CaptureGpuClipboxSeamProofForBenchmark() =>
		_gpuTerrainBackend?.RunTestOnlySeamProof();
	...
	private static string FormatGpuClipboxSeamProof( VoxelGpuClipboxSeamProofReport report ) =>
		$"result={(report.Passed ? "PASS" : "FAIL")}; transitions={report.PublishedTransitions}/{report.ActiveTransitions}; missing={report.MissingTransitions}; dependencies={report.DependencyMismatches}; faceMasks={report.FaceMaskMismatches}; invalidIndices={report.InvalidIndices}; degenerate={report.DegenerateTriangles}; duplicates={report.DuplicateRegularTriangles + report.DuplicateTransitionTriangles + report.CrossOwnerDuplicateTriangles} (regular={report.DuplicateRegularTriangles}, transition={report.DuplicateTransitionTriangles}, crossOwner={report.CrossOwnerDuplicateTriangles}, lod5={report.Lod5DuplicateTriangles}); collapsedTransitions={report.CollapsedTransitionMeshes}; undeformedCoarseBoundaryVertices={report.UndeformedCoarseBoundaryVertices}; backfacingTransitionTriangles={report.BackfacingTransitionTriangles}; boundary={report.BoundaryVertices}/{report.UnmatchedBoundaryVertices}; maxSeamError={report.MaximumSeamPositionError:F6}; readback={FormatBytes( report.GeometryReadbackBytes )}; failure={report.Failure}";
